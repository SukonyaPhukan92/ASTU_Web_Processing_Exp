...
<header>
  ...
  <body>
    <form method="post"
      ...
      <p><label>Personal Website: <input type=text id="intWebsite" pattern="https?//.+" title="Must begin with http:// or https://"
	  name="website" placeholder=" Personal Website"></label></p>
